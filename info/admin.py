...
from .models import Dept, Class, Student, Attendance, Course, Teacher, Assign, AssignTime, AttendanceClass,AddExam,QuestionBank,paper,result,eachexam
