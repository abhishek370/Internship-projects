...
class Class(models.Model):
    ...
    fees = models.FloatField(_("Amount"), null=True, blank=True, default=150000)
    month = models.IntegerField(null=True, blank=True,default=12)
    class Meta:
...
class Student(models.Model):
    ...
    amount = models.FloatField(_("Amount"), null=True, blank=True, default=15000)
...
class paper(models.Model):
    ...
    teacher = models.ForeignKey(Teacher, on_delete=models.CASCADE)
    course = models.ForeignKey(Course, on_delete=models.CASCADE)
    mark_format = models.CharField(max_length=10)
    marks = models.IntegerField()
    Question = models.ManyToManyField(QuestionBank)
    # each_mark = models.ManyToManyField('self',null=True)

class eachexam(models.Model):
